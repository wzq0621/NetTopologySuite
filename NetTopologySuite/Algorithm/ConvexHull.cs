...
namespace NetTopologySuite.Algorithm
{
    ...
    public class ConvexHull
    {
        ...
        public static Geometry Create(IEnumerable<Geometry> geoms)
        {
            ...
            return new ConvexHull(filter.Coordinates, factory, assumeUnique: true).GetConvexHull();
        }
        ...
        public ConvexHull(Geometry geometry)
            : this(ExtractCoordinates(geometry), geometry?.Factory, assumeUnique: true) { }
        ...
        public ConvexHull(IEnumerable<Coordinate> pts, GeometryFactory geomFactory)
            : this(pts ?? Enumerable.Empty<Coordinate>(), geomFactory, assumeUnique: false) { }

        private ConvexHull(IEnumerable<Coordinate> pts, GeometryFactory geomFactory, bool assumeUnique)
        {
            if (!assumeUnique)
            {
                pts = pts.Distinct();
